...
let CONTRACT_KB = {
 ...
 { id:"SAA-2.2", doc:"SAA", topic:"QRC 계약 조건", core:"Target End Customer에 Palantir Products 재판매 시 End Customer Software Access Terms 구속 필수. KT는 독립적으로 End Customer 가격 결정.", text:"Partner may resell a subscription to the Palantir Products via the End Customer Ordering Document. Partner will independently determine the pricing at which it offers Palantir Products to End Customers. Partner will be solely responsible for collecting all fees from End Customers and making payment to Palantir. Non-payment by End Customers will not relieve Partner of its obligation to pay fees to Palantir.", kt_risk:"End Customer 미지급과 무관하게 KT의 Palantir 지급 의무 존속. KT가 End Customer 대금 미수금 위험 전부 부담." },
 { id:"SAA-2.8", doc:"SAA", topic:"Upstream Payment 의무", core:"Hurdle 달성 후 Net Revenue에서 Partner Compensation 차감 후 30일 내 Palantir에 Upstream Payment 의무.", text:"Only in the case that aggregate Net Revenue is equal to or greater than the Hurdle, Partner shall forward to Palantir the full payment amount of the Net Revenue in USD received for each Qualified Resale Contract minus any applicable Partner Compensation (the Upstream Payment) within 30 days of Partner receiving an invoice. Partner shall be responsible for the payment of any and all taxes on payments received from an End Customer.", kt_risk:"Hurdle 달성 후 End Customer 수금 후 30일 내 Upstream Payment 의무. 환율 변동(OANDA 기준)에 따른 환차손 KT 부담." },
 { id:"SAA-2.9", doc:"SAA", topic:"분기 보고 의무", core:"매 분기 첫 영업일에 체결된 QRC 현황 보고 필수. 미보고 시 계약 위반.", text:"By the first business day of every quarter, Partner shall submit, in the format provided by Palantir, a report of all Qualified Resale Contracts (a) executed in such quarter and (b) for which payments and/or access to the Palantir Products are ongoing in such quarter. Partner will maintain complete, clear and accurate records of its transactions for at least 3 years following expiration or termination of the Agreement.", kt_risk:"분기 보고 미제출 시 계약 위반. 감사 요청 시 3년치 거래 기록 제출 의무. 보고 형식은 Palantir이 지정." },
 ...
 { id:"SAA-APP6", doc:"SAA", topic:"Appendix 6 보험사 목록",
  core:"Target Market 보험사 21개사 (신한라이프/DB손해·생명/현대해상/서울보증/한화생명·손해/ABL생명/캐롯손해/메리츠화재/KB손해·생명/KDB생명/삼성생명·화재/하나생명·손해/미래에셋생명/농협손해·생명/교보생명). DB손해보험 기존 Pilot은 계약 적용 제외.",
  text:"Appendix 6 Approved Insurance Companies: Shinhan Life, DB Insurance (existing Pilot excluded), DB Life, Hyundai Marine & Fire, Seoul Guarantee, Hanwha Life, Hanwha General, ABL Life, Carrot General, Meritz Fire & Marine, KB Insurance, KDB Life, KB Life, Samsung Life, Samsung Fire & Marine, Hana Life, Hana General, Mirae Asset Life, NongHyup General, NongHyup Life, Kyobo Life.",
  kt_risk:"목록 외 보험사 영업 시 SAA §6.2 material breach. DB손해보험 기존 Pilot 개입 시 EBT(SAA §2.9) 처리 필요." },
 { id:"SAA-APP7", doc:"SAA", topic:"Appendix 7 Co-Sell 10개사",
  core:"Other Market Co-Sell 대상 10개사: 현대자동차, 기아, 포스코, 한화시스템, 현대로템, 현대글로비스, CJ제일제당, 한국해양진흥공사(KOBC), 서울아산병원, 산업통상자원부. Co-Sell 수익은 Hurdle 미산입.",
  text:"Appendix 7 Approved Co-Sell Companies: Hyundai Motor Company, Kia Corporation, Posco, Hanwha Systems, Hyundai Rotem, Hyundai Glovis, CJ CheilJedang, Korea Ocean Business Corporation (KOBC), Asan Medical Center, Ministry of Trade Industry and Energy. License fees NOT counted toward Hurdle; Partner receives Co-Sell Referral Fee only.",
  kt_risk:"이 10개사 외 Other Market 고객 적극 마케팅 시 SAA §1.6.8 위반. Co-Sell 최종 가격 결정은 Palantir 독점. Hurdle 산입 불가." },
 ...
 { id:"REG-협력사-4조", doc:"협력사선정지침", topic:"협력사 등록 요건", core:"신용등급 B- 이상, TL9000/ISO9001 인증 필요" },
  ...
  { id:"LAW-하도급-13조", doc:"하도급법", topic:"하도급대금 지급의무 (60일)", core:"목적물 수령일로부터 60일 이내 지급 의무. 연체 시 공정위 고시 이율(연 15.5%) 적용.", text:"원사업자는 목적물 수령일로부터 60일 이내 하도급대금 지급 의무. 연체 시 공정위 고시 이율(연 15.5%) 이자 부담. TOS §7 월 1.5%(연 18%)보다 낮아 하도급법 적용이 KT에 유리.", kt_risk:"하도급법 적용 여부에 따라 적용 이율 결정. KT가 원사업자인 경우 하도급법 강행규정 우선 적용." },
  { id:"LAW-공정거래-45조", doc:"공정거래법", topic:"불공정거래행위 금지", core:"거래상 지위 남용, 불이익 제공 금지. Palantir TOS §8.4 즉시 정지권의 불공정거래행위 해당 여부 검토 가능.", text:"불공정한 거래방법으로 경쟁 저해·상대방 불이익 초래 금지. 거래상 지위 남용 금지.", kt_risk:"입증 부담은 KT에 있음. 공정위 신고 레버리지 활용 가능하나 협상 수단으로만 활용 권장." },
 ],
 conflicts: [
